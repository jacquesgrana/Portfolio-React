...
const AccordionItemHomeDiplomas = (props: AccordionItemHomeDiplomasProps) => {
    return (
        <Accordion.Item eventKey="2" className="mb-2">
            <Accordion.Header>
                <h3 className="title-2-bold text-white mt-2 ms-0"><span id="accordion-bullet-2" className="accordion-bullet text-orange me-1 transition-03s">•</span>  <span id="accordion-title-2" className="accordion-title transition-03s text-space-2">Formation &&nbsp;diplômes</span></h3>
            </Accordion.Header>
            <Accordion.Body >
